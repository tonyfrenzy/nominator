  ...
  <div class="container" style="min-height: 54vh;">
    <div class="mb-3">
      ...
      <input
        ...
        v-model="movieQuery"
        type="text"
        class="form-control form-control-lg bg-dark text-white col text-center"
      ...
      <div class="col-md-8">
        <section class="list-group pt-2">
          <div class="list-group-item text-center">
            <p>
              Movies results for <em class="lead">{{ movieQuery }}</em
              >: <em class="font-weight-bold">{{ movieResultsCount }}</em>
            </p>
          </div>
            ...
            <div class="media mr-2">
              ...
              <div class="media-body text-left">
                ...
                <button
                  ...
                  :disabled="deactivateNominationButton(movie)"
                  title="add to nomination lists"
                >
                  Nominate
                </button>
              </div>
      ...
      <div class="col-md-4">
        <section class="list-group sticky-top pt-2">
          <div class="list-group-item text-center font-weight-bold">
            ...
            <div
              class="alert alert-warning font-weight-normal"
              role="alert"
